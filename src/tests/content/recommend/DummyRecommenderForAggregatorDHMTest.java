...
import content.recommend.PeerRecommendationAggregatorDHM;
...
public class DummyRecommenderForAggregatorDHMTest extends DummyActor {
    ...
    private void startAggregatorTest() {
        ...
        ActorRef aggregatorToTest = getContext().actorOf(Props.create(PeerRecommendationAggregatorDHM.class), ActorNames.AGGREGATOR);
